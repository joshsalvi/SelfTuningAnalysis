function		[dip, p_value, xlow,xup]=HartigansDipSignifTest_norm(xpdf,nboot)
...
boot_dip=[];
for i=1:nboot
   normpdfboot = sort(normrnd(0,1,1,N));
   [norm_dip] = HartigansDipTest(normpdfboot);
   boot_dip=[boot_dip; norm_dip];
end;
